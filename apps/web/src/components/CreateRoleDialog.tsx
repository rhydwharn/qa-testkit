...
export function CreateRoleDialog({ tenantId, onRoleCreated }: CreateRoleDialogProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new role for your workspace and assign permissions to it.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              id="role-name"
              placeholder="e.g., QA Manager, Functional Tester"
              value={name}
